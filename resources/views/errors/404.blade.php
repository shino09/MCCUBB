@extends('layouts.admin')
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    @include('alerts.errors')
      <h1>
 Bienvenido al Sistema Web para la Gestión del Magister de Ciencias en la Computación de la  Facultad de Ciencias Empresariales        <small>Universidad del Bío-Bío</small>
      </h1>
