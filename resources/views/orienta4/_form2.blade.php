...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-success  btn-circle" 
                   href="javascript:if(confirm('¿Quiere que ese profesor dirija una ALUMNO?')) ajaxLoad('orienta4/list3/{{$ALUMNO_id}}')">D 
                     </a>-->


                       <a class="btn btn-primary btn-circle" title="Edit"
                   href="javascript:ajaxLoad('orienta4/list2update/{{$id}}/{{$ALUMNO_id}}')">
...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    ...
    <div class="col-md-6">
        {!! Form::text("ALUMNO_id",null,["class"=>"form-control required","id"=>"focus"]) !!}
        <span id="VIS_UNIVERSIDAD-error" class="help-block"></span>
    </div>
     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:ajaxLoad('orienta4/list3update/{{$id}}/{{$ALUMNO_id}}')"><i class="fa fa-list"></i> 
                     </a>
</div>
