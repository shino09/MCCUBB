...
<th align="left"> RUT Profesor Director de Tesis:</th>  <td align="left"><?php echo $PRO->id; ?> </td>  
     </tr>
      <tr>

 <th align="left"> Nombre Profesor Director de Tesis:</th>  <td align="left"><?php echo $PRO->PRO_NOMBRES; ?> <?php echo $PRO->PRO_PATERNO; ?> <?php echo $PRO->PRO_MATERNO; ?></td>   
          </tr>
