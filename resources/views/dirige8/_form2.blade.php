...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    ...
    <div class="col-md-6">
        {!! Form::text("NUCLEO_id",null,["class"=>"form-control required","id"=>"focus"]) !!}
        <span id="VIS_UNIVERSIDAD-error" class="help-block"></span>
    </div>
     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:ajaxLoad('dirige8/list2update/{{$id}}/{{$NUCLEO_id}}')"><i class="fa fa-list"></i> 
                     </a>
</div>
...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-success  btn-circle" 
                   ...
                   href="javascript:ajaxLoad('dirige8/list3update/{{$id}}/{{$NUCLEO_id}}')">
