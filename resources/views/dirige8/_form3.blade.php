...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:if(confirm('¿Quiere que ese profesor dirija una tesis?')) ajaxLoad('dirige8/list3/{{$NUCLEO_id}}')">D 
                     </a><i class="fa fa-list"></i> </a>-->


                       <a class="btn btn-primary btn-circle" title="Edit"
                   href="javascript: ajaxLoad('dirige8/list2update/{{$id}}/{{$NUCLEO_id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}')">
...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    ...
    <div class="col-md-6">
        {!! Form::text("NUCLEO_id",$NUCLEO_id,["class"=>"form-control required","id"=>"focus","readonly"]) !!}
        <span id="VIS_UNIVERSIDAD-error" class="help-block"></span>
    </div>
     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript: ajaxLoad('dirige8/list3update/{{$id}}/{{$NUCLEO_id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}')"><i class="fa fa-list"></i> </a>
                     </a>
</div>
