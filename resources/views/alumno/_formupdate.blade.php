...
<div class="form-group col-xs-6  required" id="form-ALU_NOMBRES-error">
    {!! Form::label("ALU_NOMBRES","Nombres *",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
...
<div class="form-group col-xs-6 required" id="form-ALU_MATERNO-error">
    {!! Form::label("ALU_MATERNO","Materno*",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
...
<div class="form-group col-xs-10 " required" id="form-profesor-error">
    {!! Form::label("UNIVERSIDAD_id","Universidad*",["class"=>"control-label col-md-2"]) !!}
    <div class="col-md-10" >
 ...
 <p class="help-block">-Email debe ser valido</p>
                ...
                <p class="help-block">-Email debe ser unico</p>

                 <p class="help-block">- Fijese que no queden  espacios en blanco antes del  Email</p>
