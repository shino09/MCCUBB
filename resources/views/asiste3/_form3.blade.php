...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:if(confirm('¿Quiere que ese profesor dirija una tesis?')) ajaxLoad('asiste3/list3/{{$CONGRESO_id}}')">D 
                     </a><i class="fa fa-list"></i> </a>-->


                       <a class="btn btn-primary btn-circle" title="Editar Alumno"
                   href="javascript: ajaxLoad('asiste3/list2update/{{$id}}/{{$CONGRESO_id}}/{{$idviejo}}/{{$CONGRESO_idviejo}}')">
...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    ...
    <div class="col-md-6">
     ...
     <a role="button"  class="btn btn-primary  btn-circle" title="Editar Congreso"
                   href="javascript: ajaxLoad('asiste3/list3update/{{$id}}/{{$CONGRESO_id}}/{{$idviejo}}/{{$CONGRESO_idviejo}}')"><i class="fa fa-list"></i> </a>
                     </a>
</div>
