...
<input type="button" name="sumar" value="sumar" onclick="sumeme();" />
...
var glo_numero;
function sumeme(){
var numero1,numero2,numero3,numero4,numero5,numero6,numero7,numero8,suma;
  alert("El numero 2 es " +document.getElementById("EVA_NOTADIRIGEINFORME").value);
    alert("El numero 1 es " +document.getElementById("EVA_NOTAPROFESOR3INFORME").value);


       numero1=parseFloat(document.getElementById("EVA_NOTADIRIGEINFORME").value).toFixed( 2 );
           numero2=parseFloat(document.getElementById("EVA_NOTADIRIGEEXPOSICION").value).toFixed( 2 );


   numero3=parseFloat(document.getElementById("EVA_NOTAPROFESOR1INFORME").value).toFixed( 2 );
    numero4=parseFloat(document.getElementById("EVA_NOTAPROFESOR1EXPOSICION").value).toFixed( 2 );
   numero5=parseFloat(document.getElementById("EVA_NOTAPROFESOR2INFORME").value).toFixed( 2 );

   numero6=parseFloat(document.getElementById("EVA_NOTAPROFESOR2EXPOSICION").value).toFixed( 2 );

   numero7=parseFloat(document.getElementById("EVA_NOTAPROFESOR3INFORME").value).toFixed( 2 );

   numero8=parseFloat(document.getElementById("EVA_NOTAPROFESOR3EXPOSICION").value).toFixed( 2 );
