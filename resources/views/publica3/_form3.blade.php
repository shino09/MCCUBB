...
<div >
     <b> Id Revista:</b>&nbsp;&nbsp;&nbsp; <?php echo  $revista->id ?>

    </div>
    <div >
     <b> Nombre de la Revista:</b>&nbsp;&nbsp;&nbsp; <?php echo  $revista->REV_NOMBRE ?>

    </div>
    <div >
     <b> Descripción Revista:</b>&nbsp;&nbsp;&nbsp; <?php echo  $revista->REV_DESCRIPCION ?>

    </div>
    <div >
     <b> Año Revista:</b>&nbsp;&nbsp;&nbsp; <?php echo  $revista->REV_ANO ?>
...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:if(confirm('¿Quiere que ese profesor dirija una tesis?')) ajaxLoad('publica3/list3/{{$REVISTA_id}}')">D 
                     </a><i class="fa fa-list"></i> </a>-->


                       <a class="btn btn-primary btn-circle" title="Edit"
                   href="javascript: ajaxLoad('publica3/list2update/{{$id}}/{{$REVISTA_id}}/{{$idviejo}}/{{$REVISTA_idviejo}}')">
...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    {!! Form::label("REVISTA_id","REVISTA *",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("REVISTA_id",$REVISTA_id,["class"=>"form-control required","id"=>"focus","readonly"]) !!}
        <span id="VIS_UNIVERSIDAD-error" class="help-block"></span>
    </div>
     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript: ajaxLoad('publica3/list3update/{{$id}}/{{$REVISTA_id}}/{{$idviejo}}/{{$REVISTA_idviejo}}')"><i class="fa fa-list"></i> </a>
                     </a>
</div>
