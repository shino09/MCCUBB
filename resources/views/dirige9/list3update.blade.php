...
<table class="table table-bordered table-striped">
 ...
 <th><a style:background-color:blue>
       ...
       <!-- <th>
            <a href="javascript:ajaxLoad('dirige9/list2update/{{$id}}/{{$NUCLEO_id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}?field=id&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                RUT
            </a>
 ...
 <th>
            <a href="javascript:ajaxLoad('dirige9/list2update/{{$id}}/{{$NUCLEO_id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}?field=PRO_PATERNO&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                Apellido Paterno
            </a>
            <i style="font-size: 12px"
               class="fa  {{ Session::get('nucleo_field')=='PRO_PATERNO'?(Session::get('nucleo_sort')=='asc'?'fa-sort-alpha-asc ':'fa-sort-alpha-desc '):'' }}">
            </i>
        </th>


         <th>
            <a href="javascript:ajaxLoad('dirige9/list2update/{{$id}}/{{$NUCLEO_id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}?field=PRO_MATERNO&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                Apellido Materno
            </a>
            <i style="font-size: 12px"
    ...
    <th>
            <a href="javascript:ajaxLoad('dirige9/list2update/{{$id}}/{{$NUCLEO_id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}?field=PRO_NOMBRES&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                Nombres
            </a>
            <i style="font-size: 12px"
       ...
       <!--
    <th>
            <a href="javascript:ajaxLoad('dirige9/list2update?field=PRO_EMAIL&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                Email
            </a>
            <i style="font-size: 12px"
         ...
         <th>
            <a href="javascript:ajaxLoad('dirige9/list2update?field=PRO_TITULO&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                DIR_TITULO
            </a>
            <i style="font-size: 12px"
           ...
           <th>
            <a href="javascript:ajaxLoad('dirige9/list2update?field=DPROGRADO&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                DIR_GRADO
            </a>
            <i style="font-size: 12px"
           ...
           <th>
            <a href="javascript:ajaxLoad('dirige9/list2update?field=PRO_TELEFONO&sort={{Session::get("nucleo_sort")=="asc"?"desc":"asc"}}')">
                DIR_telefono
            </a>
            <i style="font-size: 12px"
    ...
    @endforeach
            ...
            <td style="text-align: center">
              ...
              <a role="button"  class="btn btn-success  btn-circle" 
                   href="javascript:if(confirm('¿Esta seguro que quiere que este profesor dirga una tesis?')) ajaxLoad('dirige9/update3/{{$id}}/{{$nucleo->id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}')"> <i class="fa fa-check-square-o"></i> 
                     </a>

              

                       <a role="button"  class="btn btn-warning  btn-circle" 
                   href="javascript:ajaxLoad('dirige9/showprofesorupdate/{{$id}}/{{$nucleo->id}}/{{$idviejo}}/{{$NUCLEO_idviejo}}')"><i class="fa fa-eye"></i> 
                     </a>
