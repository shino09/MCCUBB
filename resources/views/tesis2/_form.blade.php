...
<div class="form-group col-xs-6  required" id="form-TES_NOMBRE-error">
    {!! Form::label("TES_NOMBRE","TES_NOMBRE*",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
...
<div class="form-group col-xs-6 required" id="form-TES_DESCRIPCION-error">
    {!! Form::label("TES_DESCRIPCION","DESCRIPCION*",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
...
<div class="form-group  col-xs-6 required" id="form-TES_ESTADO-error">
    ...
    <div class="col-md-6">
            ...
            {!! Form::select('TES_ESTADO', ['0' => 'Inscrita','1' => 'Renunciada' ,'2' => 'Postergada' ,'3' => 'No cumple requisito' ],null,['required', 'class' => 'form-control','placeholder'=>'Selecione TES_ESTADO']) !!}
...
<div class="form-group col-xs-6   required" id="form-TES_FECHAINICIO-error">
    {!! Form::label("TES_FECHAINICIO","FECHAINICIO*",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
{!! Form::text('TES_FECHAINICIO', null, array('class' => 'form-control input-sm','placeholder' => 'Ingrese una fecha','data-provide' => 'datepicker')) !!}
...
<div class="form-group col-xs-12 " required" id="form-profesor-error">
    {!! Form::label("ALUMNO_id","alumno*",["class"=>"control-label col-md-2"]) !!}
    <div class="col-md-8" >
     

            {!! Form::select('ALUMNO_id', $alumno,null,['required', 'class' => 'form-control','placeholder'=>'Selecione profesor']) !!}
