...
<b>Profesor:</b>&nbsp;&nbsp;&nbsp; <?php echo $profesor->PRO_NOMBRES ?>  <?php echo $profesor->PRO_PATERNO ?>  <?php echo $profesor->PRO_MATERNO ?>
    ...
    <br>
                ...
                <p class="help-block"><span style="color:#FF0000"> Campos Universidad y Pais son obligatorios </p>
...
<div class="form-group col-xs-12 required" id="form-id-error">

  
</div>
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    {!! Form::label("VIS_UNIVERSIDAD","Universidad*",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("VIS_UNIVERSIDAD",null,["class"=>"form-control required","id"=>"focus"]) !!}
        <span id="VIS_UNIVERSIDAD-error" class="help-block"></span>
    </div>
</div>

<div class="form-group col-xs-6 required" id="form-VIS_PAIS-error">
    {!! Form::label("VIS_PAIS","Pais*",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("VIS_PAIS",null,["class"=>"form-control required","id"=>"focus"]) !!}
        <span id="VIS_PAIS-error" class="help-block"></span>
    </div>
</div>
