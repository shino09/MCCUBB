...
<?php if (($VIS->id)==($PRO->id)) { ?>               
  ...
  <?php echo $VIS->VIS_UNIVERSIDAD; break; ?>
...
<tr>
        ...
        <th align="left">   Pais:</th>  <td align="left">
    @foreach($visitante as $VIS)


<?php if (($VIS->id)==($PRO->id)) { ?>               

  <?php echo $VIS->VIS_PAIS; break; ?>
...
<div>
    ...
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('visitante2/list')" class="btn btn-danger"><i
