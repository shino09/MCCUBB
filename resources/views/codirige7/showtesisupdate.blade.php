...
<th align="left"> Fecha Inicio:</th>  <td align="left"><?php echo $TES->TES_FECHAINICIO; ?></td>   
     </tr>

     <th align="left"> Fecha Final:</th>  <td align="left"><?php echo $TES->TES_FECHAFINAL; ?></td>   
     </tr>
      <tr>
...
<div>
    ...
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('codirige7/list2update/{{$idviejo}}/{{$pro_id}}/{{$idviejo}}/{{$PROFESOR_idviejo}}')" class="btn btn-danger"><i
