...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   ...
                   href="javascript: ajaxLoad('codirige7/list2update/{{$id}}/{{$PROFESOR_id}}/{{$idviejo}}/{{$PROFESOR_idviejo}}')">
...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    ...
    <div class="col-md-6">
     ...
     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:ajaxLoad('codirige7/list3update/{{$id}}/{{$PROFESOR_id}}/{{$idviejo}}/{{$PROFESOR_idviejo}}')"><i class="fa fa-list"></i> </a>
                     </a>
</div>
