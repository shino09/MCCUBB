...
<div >
     <b> Id Beneficio:</b>&nbsp;&nbsp;&nbsp; <?php echo  $beneficio->id ?>

    </div>
    <div >
     <b> Nombre del Beneficio:</b>&nbsp;&nbsp;&nbsp; <?php echo  $beneficio->BEN_NOMBRE ?>

    </div>
    <div >
     <b> Descripción Beneficio:</b>&nbsp;&nbsp;&nbsp; <?php echo  $beneficio->BEN_DESCRIPCION ?>
...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:if(confirm('¿Quiere que ese profesor dirija una tesis?')) ajaxLoad('posee3/list3/{{$BENEFICIO_id}}')">D 
                     </a><i class="fa fa-list"></i> </a>-->


                       <a class="btn btn-primary btn-circle" title="Edit"
                   href="javascript: ajaxLoad('posee3/list2update/{{$id}}/{{$BENEFICIO_id}}/{{$idviejo}}/{{$BENEFICIO_idviejo}}')">
...
<div class="form-group col-xs-6 required" id="form-VIS_UNIVERSIDAD-error">
    {!! Form::label("BENEFICIO_id","BENEFICIO *",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("BENEFICIO_id",$BENEFICIO_id,["class"=>"form-control required","id"=>"focus","readonly"]) !!}
        <span id="VIS_UNIVERSIDAD-error" class="help-block"></span>
    </div>
     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript: ajaxLoad('posee3/list3update/{{$id}}/{{$BENEFICIO_id}}/{{$idviejo}}/{{$BENEFICIO_idviejo}}')"><i class="fa fa-list"></i> </a>
                     </a>
</div>
