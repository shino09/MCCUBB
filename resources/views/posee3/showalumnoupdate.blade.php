<h5 class="page-header">Datos Alumno
...
<th align="left"> Email:</th>  <td align="left"><?php echo $alu->ALU_EMAIL; ?></td>   
      ...
      <tr>
        ...
        <th align="left">   Universidad egreso:</th>  <td align="left">
...
<div>
    ...
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('posee3/list2update/{{$id}}/{{$BENEFICIO_id}}/{{$idviejo}}/{{$BENEFICIO_idviejo}}')" class="btn btn-danger"><i
