...
<th align="left"> RUT:</th>  <td align="left"><?php echo $PRO->id; ?> </td>  
 ...
 <th align="left"> NOMBRES:</th>  <td align="left"><?php echo $PRO->PRO_NOMBRES; ?></td>   
          </tr>
 <tr>
...
<?php if (($DEP->DEP_ID)==($PRO->DEPARTAMENTO_DEP_ID)) { ?>               
...
<div>
    ...
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('conforman17/list2update/{{$id}}/{{$TRIBUNAL_id}}/{{$idviejo}}/{{$TRIBUNAL_idviejo}}')" class="btn btn-danger"><i
