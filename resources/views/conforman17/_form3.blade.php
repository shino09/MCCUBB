...
<div class="form-group col-xs-6 required" id="form-id-error">
    ...
    <div class="col-md-6">
     ...
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   ...
                   href="javascript: ajaxLoad('conforman17/list2update/{{$id}}/{{$TRIBUNAL_id}}/{{$idviejo}}/{{$id2viejo}}/{{$id3viejo}}')">
...
<div class="form-group col-xs-6 required" id="form-id-error">
    {!! Form::label("id2","PROFESOR2 *",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("id2",$id2,["class"=>"form-control required","id"=>"focus"]) !!}
        <span id="id-error" class="help-block"></span>
    </div>

     <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript: ajaxLoad('conforman17/list2update/{{$id}}/{{$TRIBUNAL_id}}/{{$idviejo}}/{{$id2viejo}}/{{$id3viejo}}')"><i class="fa fa-list"></i> </a>
                     </a>
</div>


<div class="form-group col-xs-6 required" id="form-id-error">
    {!! Form::label("id3","PROFESOR3 *",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("id3",$id3,["class"=>"form-control required","id"=>"focus"]) !!}
        <span id="id-error" class="help-block"></span>
    </div>
     <!-- <a role="button"  class="btn btn-primary  btn-circle" 
                   href="javascript:if(confirm('¿Quiere que ese profesor dirija una TRIBUNAL?')) ajaxLoad('conforman17/list3/{{$TRIBUNAL_id}}')">D 
