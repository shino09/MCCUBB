...
<div class="form-group required" id="form-DEP_NOMBRE-error">
    ...
    <div class="col-md-6">
        {!! Form::text("DEP_ID",null,["class"=>"form-control required","id"=>"focus", "readonly"]) !!}
...
<div class="form-group required" id="form-DEP_NOMBRE-error">
    {!! Form::label("DEP_NOMBRE","Nombre",["class"=>"control-label col-md-3"]) !!}
    <div class="col-md-6">
        {!! Form::text("DEP_NOMBRE",null,["class"=>"form-control required","id"=>"focus", "readonly"]) !!}
        <span id="DEP_NOMBRE-error" class="help-block"></span>
    </div>
</div>
...
<div class="form-group required" id="form-DEP_NOMBRE-error">
    ...
    <div class="col-md-6">
        {!! Form::text("DEP_FACULTAD",null,["class"=>"form-control required","id"=>"focus", "readonly"]) !!}
        <span id="DEP_NOMBRE-error" class="help-block"></span>
    </div>
</div>
