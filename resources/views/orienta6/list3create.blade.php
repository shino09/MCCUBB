...
<div class="col-sm-7 form-group">
    <div class="input-group">
        <input class="form-control" id="search" value="{{ Session::get('orientaprofesorcreate_search') }}"
               onkeydown="if (event.keyCode == 13)  ajaxLoad('orienta6/list3create/{{$ALUMNO_id}}?ok=1&search='+this.value)"
               placeholder="Buscar Profesor por Apellido Paterno o RUT"
               type="text">

        <div class="input-group-btn">
            <button type="button" class="btn btn-default"
                    onclick="ajaxLoad('orienta6/list3create/{{$ALUMNO_id}}?ok=1&search='+$('#search').val())"><i
...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <!--  <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=id&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                RUT
            </a>
 ...
 <th>
            <a href="javascript:ajaxLoad('orienta6/list3create/{{$ALUMNO_id}}?field=PRO_PATERNO&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                Nombre Profesor
            </a>
            <i style="font-size: 12px"
...
<!--
         ...
         <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=PRO_MATERNO&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                Apellido Materno
            </a>
            <i style="font-size: 12px"
    ...
    <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=PRO_NOMBRES&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                Nombres
            </a>
            <i style="font-size: 12px"
       ...
       <!--
    <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=PRO_EMAIL&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                Email
            </a>
            <i style="font-size: 12px"
    ...
    <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=PRO_TITULO&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                TITULO
            </a>
            <i style="font-size: 12px"
    ...
    <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=PRO_GRADO&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                GRADO
            </a>
            <i style="font-size: 12px"
    ...
    <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=PRO_TELEFONO&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                TELEFONO
            </a>
            <i style="font-size: 12px"
         ...
         <th>
            <a href="javascript:ajaxLoad('orienta6/list2create?field=DEPARTAMENTO_id&sort={{Session::get("orientaprofesorcreate_sort")=="asc"?"desc":"asc"}}')">
                Departamento
            </a>
            <i style="font-size: 12px"
    ...
    @endforeach
            ...
            <td style="text-align: center">
             ...
             <a role="button"  class="btn btn-success  btn-circle" 
                   href="javascript:if(confirm('¿Esta seguro que quiere selecionar  este profesor ?')) ajaxLoad('orienta6/create/{{$ALUMNO_id}}/{{$profesor->id}}')"> <i class="fa fa-check-square-o"></i> 
                     </a>
                  

                       <a role="button"  class="btn btn-warning  btn-circle" 
                   href="javascript:ajaxLoad('orienta6/showprofesorcreate/{{$ALUMNO_id}}/{{$profesor->id}}')"><i class="fa fa-eye"></i> 
                     </a>
...
<br>
<div>
  <a href="javascript:ajaxLoad('orienta6/list2create')" class="btn btn-danger"><i
