...
<div class="col-sm-7 form-group">
    <div class="input-group">
        <input class="form-control" id="search" value="{{ Session::get('orientaprofesorupdate_search') }}"
               onkeydown="if (event.keyCode == 13) ajaxLoad('orienta6/list3update/{{$id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}?ok=1&search='+this.value)"
               placeholder="Buscar Profesor por Apellido Paterno o RUT"
               type="text">

        <div class="input-group-btn">
            <button type="button" class="btn btn-default"
                    onclick=" ajaxLoad('orienta6/list3update/{{$id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}?ok=1&search='+$('#search').val())"><i
...
<table class="table table-bordered table-striped">
    ...
    <tr>
       ...
       <!-- <th>
            <a href="javascript:ajaxLoad('orienta6/list2update/{{$id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}?field=id&sort={{Session::get("orientaprofesorupdate_sort")=="asc"?"desc":"asc"}}')">
                RUT
            </a>
...
<th>
            <a href="javascript:ajaxLoad('orienta6/list3update/{{$id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}?field=PRO_PATERNO&sort={{Session::get("orientaprofesorupdate_sort")=="asc"?"desc":"asc"}}')">
                Nombre Profesor
            </a>
            <i style="font-size: 12px"
...
<!--
         ...
         <th>
            <a href="javascript:ajaxLoad('orienta6/list2update/{{$id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}?field=PRO_MATERNO&sort={{Session::get("orientaprofesorupdate_sort")=="asc"?"desc":"asc"}}')">
                Apellido Materno
            </a>
            <i style="font-size: 12px"
    ...
    <th>
            <a href="javascript:ajaxLoad('orienta6/list2update/{{$id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}?field=PRO_NOMBRES&sort={{Session::get("orientaprofesorupdate_sort")=="asc"?"desc":"asc"}}')">
                Nombres
            </a>
            <i style="font-size: 12px"
  ...
  <?php } ?>
    ...
    @endforeach
            ...
            <td style="text-align: center">
                   ...
                   href="javascript:if(confirm('¿Esta seguro que quiere seleccionar  este profesor?')) ajaxLoad('orienta6/update3/{{$profesor->id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}')"> <i class="fa fa-check-square-o"></i> 
                     </a>

              

                       <a role="button"  class="btn btn-warning  btn-circle" 
                   href="javascript:ajaxLoad('orienta6/showprofesorupdate/{{$profesor->id}}/{{$ALUMNO_id}}/{{$idviejo}}/{{$ALUMNO_idviejo}}')"><i class="fa fa-eye"></i> 
                     </a>
